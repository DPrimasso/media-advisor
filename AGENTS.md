...
- **No database**: all data is flat JSON files in `channels/`, `data/transcripts/`, `data/analysis/`.
...
- The Tutti/Trend/Squadre dashboard pages show a JSON parse error when `data/analysis/` directory is empty (no pipeline data). This is expected without API keys — the Inbox page works independently via the Express API.
